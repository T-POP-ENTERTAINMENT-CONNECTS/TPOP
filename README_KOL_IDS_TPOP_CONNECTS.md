...
## Routing
- T POP homepage `index.html` now sends every KOL IDS CTA to `./KOL_IDS.html` on the same origin.
- `KOL_IDS.html` is the same-origin entry point and opens `workspace.html`.
